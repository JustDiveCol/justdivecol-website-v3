  ...
  return (
    ...
    >
      <div className="container mx-auto text-center mb-12">
        {/* Header */}
        <MotionBlock kind="inView" variants={fadeIn()} className="mb-16">
          <h2 id="allies-heading" className="heading-4 text-brand-white">
            {t(titleKey)}
          </h2>
        </MotionBlock>
          ...
          >
            ...
            >
              {[...logos, ...logos].map((ally, index) => (
                <div key={`${ally.id}-${index}`} className="mx-6 md:mx-8">
                  <AllyLogo ally={ally} />
                </div>
              ))}
            </div>
