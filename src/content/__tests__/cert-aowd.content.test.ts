...
import { padiOpenWaterContent } from '../certifications/padi-advanced-open-water-diver.content';

describe('Certification: PADI Advanced Open Water Diver', () => {
  ...
  it('tiene las secciones base (PageContent) + secciones propias de certificación', () => {
    ...
    // propias de CertificationContent
  ...
  it('card con imageData (puede incluir complementaryLogo)', () => {
    ...
    // complementaryLogo si existe debe tener url/altKey
