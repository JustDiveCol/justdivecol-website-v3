// src/content/experiences/sessions/isla-fuerte-oct-26-sess.content.ts
...
const rawIslaFuerteOct26Sess: ExperienceSessionContent = {
  id: 'isla-fuerte-oct-26-sess',
  nameKey: 'experiences.islaFuerteExp.sessions.oct26.name',
...
export const islaFuerteOct26SessContent = ExperienceSessionContentSchema.parse(
  rawIslaFuerteOct26Sess
);
