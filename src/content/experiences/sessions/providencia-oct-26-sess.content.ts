// src/content/experiences/sessions/providencia-oct-26-sess.content.ts
...
const rawProvidenciaOct26Sess: ExperienceSessionContent = {
  id: 'providencia-oct-26-sess',
  nameKey: 'experiences.providenciaExp.sessions.oct26.name',
  ...
  pricingOptions: [
    {
      id: 'open-water',
      nameKey: 'experiences.providenciaExp.sessions.oct26.pricingOptions.opt1',
      price: 4600000,
      currency: 'COP',
    },
    {
      id: 'advanced-open-water',
      nameKey: 'experiences.providenciaExp.sessions.oct26.pricingOptions.opt2',
      price: 4600000,
      currency: 'COP',
    },
    {
      id: 'fun-dive',
      nameKey: 'experiences.providenciaExp.sessions.oct26.pricingOptions.opt3',
      price: 3700000,
      currency: 'COP',
    },
    {
      id: 'companion',
      nameKey: 'experiences.providenciaExp.sessions.oct26.pricingOptions.opt4',
      price: 2300000,
      currency: 'COP',
    },
  ],
    ...
    installments: [
      {
        ...
        percentage: 50,
        descriptionKey:
          'experiences.providenciaExp.sessions.oct26.paymentPlan.installments.desc1',
      },
      {
        date: '2026-01-20',
        percentage: 25,
        descriptionKey:
          'experiences.providenciaExp.sessions.oct26.paymentPlan.installments.desc2',
      },
      {
        date: '2026-02-06',
        percentage: 25,
        descriptionKey:
          'experiences.providenciaExp.sessions.oct26.paymentPlan.installments.desc3',
      },
    ],
  },
...
export const providenciaOct26SessContent = ExperienceSessionContentSchema.parse(
  rawProvidenciaOct26Sess
);
