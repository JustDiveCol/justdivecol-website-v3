// src/content/pages/under-construction/types.ts
import { z } from 'zod';
import {
  ContentButtonSchema,
  SEOPropsSchema,
...
export const UnderConstructionPageContentSchema = z.object({
  seo: SEOPropsSchema,
  hero: HeroSectionPropsSchema,
});

export type UnderConstructionPageContent = z.infer<
  typeof UnderConstructionPageContentSchema
>;
