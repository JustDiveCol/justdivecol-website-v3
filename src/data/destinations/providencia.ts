...
const providencia: Destination = {
  ...
  seo: {
    ...
    imageUrl: '/images/destinations/providencia/header.webp',
    url: `${ROUTES.destinations}/providencia`,
  },
  header: {
    backgroundImage: '/images/destinations/providencia/header.webp',
  ...
  gallery: {
    ...
    images: [
      {
        backgroundImage: '/images/destinations/providencia/gallery-01.webp',
        altTextKey: 'smGal1Alt',
      },
      {
        backgroundImage: '/images/destinations/providencia/gallery-02.webp',
  ...
  // Relaciones
  experienceIds: ['exp-providencia-fun-dive'], // IDs de experiencias en este destino
